 ...
 *
 * Identical to the Android app's `utils/RpcText.kt` - same bug, same fix, same file twice. It is a
 * pure Kotlin utility with no Android dependency, so it belongs in the shared-module cleanup noted in
 * HANDOVER.md alongside Biquad, Compressor and the AutoEQ parser, not duplicated indefinitely.
 */
